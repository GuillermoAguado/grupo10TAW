...
public class CreaEventoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (maximoEntradasUsuario < 1) throw new IllegalArgumentException("El maximo de entradas debe ser positivo");
            int nFilas;
            int asientosFila;
            ...
            RequestDispatcher rd = request.getRequestDispatcher("EditaEventoServlet?error=true");
