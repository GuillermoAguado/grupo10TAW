...
public class ServletCopiarEstudio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Estudiobd> lista = new ArrayList<>();
        Estudiobd estudio = this.estudiobdFacade.find(new Integer(idestudio));
        Usuario usuario = this.usuarioFacade.find(new Integer(idanalista));
        
        Estudiobd estudio2 = estudio;  
        String nombre = estudio.getNombre() + "(Copia)";
        estudio2.setNombre(nombre);
        this.estudiobdFacade.create(estudio2);
        usuario.getEstudiobdList1().add(estudio2);
